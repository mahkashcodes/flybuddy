...
Route::get('/destinations/{id}', [DestinationController::class, 'show'])->name('destinations.show'); // ← MUST BE PUBLIC!
Route::get('/packages', [TravelPackageController::class, 'index'])->name('packages.index');
Route::get('/packages/{id}', [TravelPackageController::class, 'show'])->name('packages.show'); // ← MUST BE PUBLIC!
